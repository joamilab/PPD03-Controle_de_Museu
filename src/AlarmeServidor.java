...
public class AlarmeServidor {
    public static void main(String args[]){
        ...
        try {
            ...
            AlarmeImpl alarme = new AlarmeImpl();
            org.omg.CORBA.Object objRef = rootPOA.servant_to_reference(alarme);
            
            NameComponent[] name = {new NameComponent("Alarme", "alarmeMuseu")};
            naming.rebind(name, objRef);
            
            rootPOA.the_POAManager().activate();
            System.out.println("Alarme servidor pronto...");
            orb.run();
            ...
            Logger.getLogger(AlarmeServidor.class.getName()).log(Level.SEVERE, null, ex);
        }
    } 
